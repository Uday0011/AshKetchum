...
import AshKetchum.modules.sql.notes_sql as sql
from AshKetchum import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER
from AshKetchum.__main__ import DATA_IMPORT
from AshKetchum.modules.helper_funcs.chat_status import user_admin
from AshKetchum.modules.helper_funcs.alternate import typing_action

# from AshKetchum.modules.rules import get_rules
import AshKetchum.modules.sql.rules_sql as rulessql

# from AshKetchum.modules.sql import warns_sql as warnssql
import AshKetchum.modules.sql.blacklist_sql as blacklistsql
from AshKetchum.modules.sql import disable_sql as disabledsql

# from AshKetchum.modules.sql import cust_filters_sql as filtersql
# import AshKetchum.modules.sql.welcome_sql as welcsql
import AshKetchum.modules.sql.locks_sql as locksql
from AshKetchum.modules.connection import connected
...
def export_data(update, context):
    ...
    f = open("AshKetchum{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("AshKetchum{}.backup".format(chat_id), "rb"),
    ...
    os.remove("AshKetchum{}.backup".format(chat_id))  # Cleaning file
